...
for (( j=start; j<=end; j++ ))
do
    python get_depth_maps.py --data-shard $j --use-metric-depth-model --batch-size 2 --data-dir /ariesdv0/zhanling/oxe-data-converted --checkpoint-path /ariesdv0/zhanling/checkpoints
